...
| J7 | 금투협 수시공시 | tmpV1(12자리), standardCd | 상품.kofia_fund_code **또는** 상품.standard_code | **코드** | 대기(주영) | 12자리가 K55…(펀드코드)인지 KR5…(표준코드)인지 미판별. 앞 3자가 `K55`면 kofia_fund_code, `KR`이면 standard_code → 미확인 20 |
