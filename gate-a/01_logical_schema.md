...
**미확인(09에서 새로 생김)**: **판매회사 명단의 소스.** 표지 10건 모두 명단 대신 「각 판매회사 본·지점」, 「집합투자업자·협회 홈페이지 참조」 문구만 있었다. 후보는 (a) 투자설명서 PDF 본문의 판매회사 절, (b) 금투협 전자공시(dis.kofia.or.kr)의 펀드별 판매회사 정보. (a)면 구조화 층 추출, (b)면 수집 소스 추가다. 판매사명은 05의 별도 임계치 0.95로 문자열 매칭한다.
...
**확정(05, 잠정값)**: 상품명 유사도 0.85 이상 자동 매칭, 0.60~0.85 수동 확인 대상, 0.60 미만 실패. 숫자 토큰은 완전 일치를 강제한다. 판매사명은 별도 임계치 0.95. 잠정값은 라벨 200건으로 확정한다. 정규화 6단계와 유사도 방법은 05를 따른다.
...
| 미정 (PDF 본문 절 또는 금투협 전자공시) | 판매회사 명단 | 상품_판매사 | 소스 미확인. 판매사명은 **문자열 매칭**(05, 임계치 0.95) |
