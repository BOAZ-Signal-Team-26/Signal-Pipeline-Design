...
**설계 문서 저장소**입니다. 코드는 들어 있지 않습니다. BOAZ Signal Team의 「판매 중인 금융상품 설명서를 전수 채점해 설명 난독성 지도를 만드는 파이프라인」의 아키텍처 설계를 **세 단계 순서대로** 담습니다. 한 번에 다 그리지 않고, 개발에 필요한 순서대로 세 번에 나눠 확정합니다.
